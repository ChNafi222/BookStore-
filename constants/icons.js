...
export const cart_icon = require("../assets/icons/my_cart.png");
export const profile_icon = require("../assets/icons/profile_icon.png");
export const buy_icon = require("../assets/icons/buy_icon.png");
export const checkout_icon = require("../assets/icons/checkout_icon.png");
